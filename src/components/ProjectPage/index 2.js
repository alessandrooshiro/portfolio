                        ...
                        <div style={{ width: '80vw', position: 'relative', left: '50%', transform: 'translate(-50%)' }}>
                            <div style={{ width: '100%', position: 'relative', left: '0', display: 'flex', flexDirection: "row", justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                <div className="projects-title" >
                                    ...
                                    <div style={{ width: '100%', position: 'relative', left: '0', margin: '80px 0 0 0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                            ...
                            <div style={{ width: '100%', position: 'relative', left: '0', margin: '120px 0 0 0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt1}</span>
                                <img alt={this.props.project.alt1} src={this.props.project.image1} style={{ width: '100%' }} />

                            </div>
                            <div style={{ width: '100%', position: 'relative', left: '0', margin: '120px 0 0 0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt2}</span>
                                <img alt={this.props.project.alt2} src={this.props.project.image2} style={{ width: '100%' }} />

                            </div>
                            <div style={{ width: '100%', position: 'relative', left: '0', margin: '120px 0 0 0', display: 'flex', flexDirection: "row", justifyContent: 'space-between' }}>
                                <div style={{ width: 'calc(50% - 15px)', position: 'relative', left: '0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                    <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt3}</span>
                                    <img alt={this.props.project.alt3} src={this.props.project.image3} style={{ width: '100%' }} />

                                </div>
                                <div style={{ width: 'calc(50% - 15px)', position: 'relative', left: '0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                    <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt4}</span>
                            ...
                            <div style={{ width: '100%', position: 'relative', left: '0', margin: '120px 0 0 0', display: 'flex', flexDirection: "row", justifyContent: 'space-between' }}>
                                <div style={{ width: 'calc(50% - 15px)', position: 'relative', left: '0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                    <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt5}</span>
                                    <img alt={this.props.project.alt5} src={this.props.project.image5} style={{ width: '100%' }} />

                                </div>
                                <div style={{ width: 'calc(50% - 15px)', position: 'relative', left: '0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                    <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt6}</span>
                                    <img alt={this.props.project.alt6} src={this.props.project.image6} style={{ width: '100%' }} />

                                </div>
                            </div>
                            <div style={{ width: '100%', position: 'relative', left: '0', margin: '120px 0 0 0', display: 'flex', flexDirection: "column", justifyContent: 'space-between' }}>
                                <span style={{ width: '100%', margin: '0px 0 10px 0', fontSize: '13px', textAlign: 'left', color: '#000', fontStyle: 'normal' }}>{this.props.project.alt7}</span>
